-- Agenda Inteligente — Schema Supabase PostgreSQL (CORRECTED)
-- Ejecutar en: https://supabase.co → SQL Editor
-- FIX: Funciones primero, luego RLS, luego tablas
...
-- =====================================================
-- 4. ROW LEVEL SECURITY (RLS) - AHORA LAS FUNCIONES EXISTEN
-- =====================================================
...
-- =====================================================
-- 5. FUNCIONES HELPER ADICIONALES
-- =====================================================
...
-- =====================================================
-- 7. TRIGGERS (Auditoría - actualizar updated_at)
-- =====================================================
...
-- =====================================================
-- 8. DATOS DE PRUEBA (Opcional - Descomentar para probar)
-- =====================================================

-- INSERT INTO configuracion (email_usuario, timezone, recordatorio_minutos)
-- VALUES ('j.castillo.bozo@gmail.com', 'America/Santiago', 15);
...
--   ('Cumpleaños María', 'Cumpleaños', now() + INTERVAL '5 days', 'María cumple 30 años', 'j.castillo.bozo@gmail.com');
